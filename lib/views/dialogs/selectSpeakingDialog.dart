...
class SelectSpeakingDialog extends StatefulWidget {
  final LessonModel lessonModel;

  const SelectSpeakingDialog({
...
///=================================================================================================
class _SelectReadingDialog extends StateSuper<SelectSpeakingDialog> {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Chip(
                          label: const Text('گفتن').bold().color(Colors.white),
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          shrinkWrap: true,
                          itemCount: widget.lessonModel.speakingSegment!.categories.length,
  ...
  Widget buildList(_, int idx){
    final itm = widget.lessonModel.speakingSegment!.categories[idx];
